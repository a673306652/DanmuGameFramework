...
namespace Chronos
{
    public class RigidbodyTimeline3D : RigidbodyTimeline<Rigidbody, RigidbodyTimeline3D.Snapshot>
    {
        ...
        public void MovePosition(Vector3 position, Vector3 dir, Timeline other = null)
        {
            if (AssertForwardForce(Severity.Ignore))
                component.MovePosition(position + dir * (other == null ? timeline.timeScale : other.timeScale));
