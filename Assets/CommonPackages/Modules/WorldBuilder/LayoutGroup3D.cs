...
public class LayoutGroup3D : MonoBehaviour
{
    ...
    public bool StopLayout;

    [HideInInspector] public bool NeedsRebuild = false;

    [Tooltip(
        "Forces the layoutgroup to rebuild every frame while in Play mode.  WARNING: This may have performance implications for very large / complex layouts, use with caution")]
