...
namespace NaughtyAttributes.Editor
{
    public static class NaughtyEditorGUI
    {
        ...
        public static int TabGroup_Tabs(int selected, IEnumerable<IGrouping<string, SerializedProperty>> tabGroups)
        {
            return GUILayout.SelectionGrid(selected, tabGroups.Select(x => x.Key).ToArray(), 3);
        }
